    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <form name="memberLoginFrm" class="space-y-6" method="POST">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="password" name="password" type="password" autocomplete="password" value="1234" required class="px-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            <div class="flex items-center">
                <input id="saveId" name="saveId" type="checkbox" onchange="saveId();" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
